...
public partial class RestoMalTiempoDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.Property(e => e.EsCajero).HasColumnName("esCajero");
            entity.Property(e => e.EsCliente).HasColumnName("esCliente");
            entity.Property(e => e.EsMozo).HasColumnName("esMozo");
            entity.Property(e => e.EsRecepcionista).HasColumnName("esRecepcionista");
            entity.Property(e => e.Nombre)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("nombre");
